    ...
    <div class="<?php echo ($ancho_completo_seccion)?"container-fluid":"container" ?>">
        <div class="row justify-content-center g-3">
            ...
            <div class="col-lg-<?php echo $columnas ?>">                
                <div class="tarjeta-isil-bilioteca">
                    <div class="descripcion-tarjeta">
                        <!-- titulo -->
                        <?php if($tarjeta['titulo']): ?>
                            <span class="h1 d-block" style="color:<?php echo $tarjeta['color_de_titulo'] ?>">
                        ...
                        <?php if($tarjeta['subtitulo']): ?>
                            <span class="h3 d-block" style="color:<?php echo $tarjeta['color_de_subtitulo'] ?>">
                        ...
                        <?php if($boton['texto']): ?>
                        <a href="<?php echo $boton['url'] ?>" target="_blank" class="btn mt-3 btn-tarjeta px-4"
